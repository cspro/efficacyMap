...
data.stateData = {
	'newYork' : {
		'institutions' : [
			...
			},
			{
				...
				'location'    : 'Hamburg',
				'outcome'     : 'Students who passed the co-requisite Composition course had an average MyWritingLab score 41 percentage points higher than students who did not pass the course. There is a positive correlation between a student’s MyWritingLab score and the average score they receive on writing assignments, suggesting that students who do well on MyWritingLab also do well on their essays.',
	...
	'texas' : {
		'institutions' : [
			{
				'id'          : 'MasteringChemistry',   
				'institution' : 'Texas City College of the City University of New York',
				'location'    : 'New York',
				'outcome'     : 'A study showed that more students received As, Bs, or Cs when the Peer-Led Team Learning model was combined with implementation of MasteringChemistry.',
				'link'        : 'http://www.pearsonmylabandmastering.com/northamerica/results/files/MC_CUNY_Final_revised.pdf?v1435095430'
			},
